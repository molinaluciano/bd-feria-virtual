...
BEGIN
    ...
    UPDATE SUBASTA SET FECHA_TERMINO = SYSDATE, CAMION_SELECCIONADO = ID_CAMION_IN WHERE ID_SUBASTA = ID_SUBASTA_IN;
...
BEGIN
    FV_TRA_AUCTION_PARTICIPATION(1, 1, 1, ID_RESULT_OUT, STATUS_RESULT_OUT);
