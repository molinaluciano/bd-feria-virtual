...
BEGIN
    ...
    SELECT COUNT(*) INTO AUCTION_COUNT FROM SUBASTA WHERE ID_SUBASTA = ID_SUBASTA_IN AND ID_ESTADO_SUBASTA = 1;
    ...
    INSERT INTO DETALLE_SUBASTA (ID_SUBASTA, ID_CAMION, PRECIO) VALUES (ID_SUBASTA_IN, ID_CAMION_IN, PRECIO_IN) RETURN ID_DETALLE_SUBASTA INTO ID_RESULT_OUT;
    UPDATE SUBASTA SET 
    FECHA_TERMINO = SYSDATE, 
    CAMION_SELECCIONADO = ID_CAMION_IN, 
    ID_ESTADO_SUBASTA = 2 
    WHERE ID_SUBASTA = ID_SUBASTA_IN;
