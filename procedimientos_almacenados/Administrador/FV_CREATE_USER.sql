...
create or replace PROCEDURE FV_CREATE_USER
 (
...
-- BEGIN
--     FV_CREATE_USER(1,1,'NUEVOADMIN','NUEVOADMIN','NUEVOADMIN', 'NUEVOADMIN@NUEVOADMIN.com','NUEVOADMIN',12345678,'k','Rencas 1673', 80001, 94986612, NULL,ID_RESULT_OUT, STATUS_RESULT_OUT);
--     DBMS_OUTPUT.PUT_LINE('ID_RESULT_OUT EXTERNO ='||ID_RESULT_OUT);
--     DBMS_OUTPUT.PUT_LINE('STATUS_RESULT_OUT EXTERNO ='||STATUS_RESULT_OUT);
--     FV_CREATE_USER(2,1,'NUEVOCLIENTEEXTERNO','NUEVOCLIENTEEXTERNO','NUEVOCLIENTEEXTERNO', 'NUEVOCLIENTEEXTERNO@NUEVOCLIENTEEXTERNO.com','NUEVOCLIENTEEXTERNO',12345678,'k','Rencas 1673', 80001, 94986612, NULL,ID_RESULT_OUT, STATUS_RESULT_OUT);
--     DBMS_OUTPUT.PUT_LINE('ID_RESULT_OUT EXTERNO ='||ID_RESULT_OUT);
--     DBMS_OUTPUT.PUT_LINE('STATUS_RESULT_OUT EXTERNO ='||STATUS_RESULT_OUT);
--     FV_CREATE_USER(3,1,'NUEVOCLIENTELOCAL','NUEVOCLIENTELOCAL','NUEVOCLIENTELOCAL', 'NUEVOCLIENTELOCAL@NUEVOCLIENTELOCAL.com','NUEVOCLIENTELOCAL',12345678,'k','Rencas 1673', 80001, 94986612, NULL,ID_RESULT_OUT, STATUS_RESULT_OUT);
--     DBMS_OUTPUT.PUT_LINE('ID_RESULT_OUT EXTERNO ='||ID_RESULT_OUT);
--     DBMS_OUTPUT.PUT_LINE('STATUS_RESULT_OUT EXTERNO ='||STATUS_RESULT_OUT);
--     FV_CREATE_USER(4,1,'NUEVOCLIENTEINTERNO','NUEVOCLIENTEINTERNO','NUEVOCLIENTEINTERNO', 'NUEVOCLIENTEINTERNO@NUEVOCLIENTEINTERNO.com','NUEVOCLIENTEINTERNO',12345678,'k','Rencas 1673', 80001, 94986612, NULL,ID_RESULT_OUT, STATUS_RESULT_OUT);
--     DBMS_OUTPUT.PUT_LINE('ID_RESULT_OUT EXTERNO ='||ID_RESULT_OUT);
--     DBMS_OUTPUT.PUT_LINE('STATUS_RESULT_OUT EXTERNO ='||STATUS_RESULT_OUT);
--     FV_CREATE_USER(5,1,'NUEVOCONSULTOR','NUEVOCONSULTOR','NUEVOCONSULTOR', 'NUEVOCONSULTOR@NUEVOCONSULTOR.com','NUEVOCONSULTOR',12345678,'k','Rencas 1673', 80001, 94986612, NULL,ID_RESULT_OUT, STATUS_RESULT_OUT);
--     DBMS_OUTPUT.PUT_LINE('ID_RESULT_OUT EXTERNO ='||ID_RESULT_OUT);
--     DBMS_OUTPUT.PUT_LINE('STATUS_RESULT_OUT EXTERNO ='||STATUS_RESULT_OUT);
--     FV_CREATE_USER(6,1,'NUEVOPRODUCTOR','NUEVOPRODUCTOR','NUEVOPRODUCTOR', 'NUEVOPRODUCTOR@NUEVOPRODUCTOR.com','NUEVOPRODUCTOR',12345678,'k','Rencas 1673', 80001, 94986612, 1,ID_RESULT_OUT, STATUS_RESULT_OUT);
--     DBMS_OUTPUT.PUT_LINE('ID_RESULT_OUT EXTERNO ='||ID_RESULT_OUT);
--     DBMS_OUTPUT.PUT_LINE('STATUS_RESULT_OUT EXTERNO ='||STATUS_RESULT_OUT);
--     FV_CREATE_USER(7,1,'NUEVOTRASNPORTISTA','NUEVOTRASNPORTISTA','NUEVOTRASNPORTISTA', 'NUEVOTRASNPORTISTA@NUEVOTRASNPORTISTA.com','NUEVOTRASNPORTISTA',12345678,'k','Rencas 1673', 80001, 94986612, NULL,ID_RESULT_OUT, STATUS_RESULT_OUT);
--     DBMS_OUTPUT.PUT_LINE('ID_RESULT_OUT EXTERNO ='||ID_RESULT_OUT);
--     DBMS_OUTPUT.PUT_LINE('STATUS_RESULT_OUT EXTERNO ='||STATUS_RESULT_OUT);
-- END;