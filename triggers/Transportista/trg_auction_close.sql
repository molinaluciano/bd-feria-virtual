create or replace NONEDITIONABLE TRIGGER TRG_AUCTION_CLOSE
AFTER UPDATE OF CAMION_SELECCIONADO ON SUBASTA 
FOR EACH ROW
DECLARE 
...
BEGIN
    ...
    RETURN ID_VENTA INTO ID_VENTA_IN;
     ...
     WHERE ID_SUBASTA = :old.ID_SUBASTA AND ID_CAMION = :new.CAMION_SELECCIONADO AND ROWNUM = 1;

     PRECIO_BRUTO_IN := ROUND((PRECIO_PROD_IN + PRECIO_CAM_IN)* 1.20);
     PRECIO_NETO_IN := ROUND(PRECIO_BRUTO_IN * 1.19);
