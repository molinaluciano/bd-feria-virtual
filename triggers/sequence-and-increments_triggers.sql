...
DROP SEQUENCE DETALLE_VENTA_INCREMENTO;
CREATE SEQUENCE DETALLE_VENTA_INCREMENTO
START WITH 1 
INCREMENT BY 1;
...
CREATE OR REPLACE TRIGGER TRG_INCREMENTO_ID_DETALLE_VENTA
BEFORE INSERT ON DETALLE_VENTA 
FOR EACH ROW
BEGIN
    SELECT DETALLE_VENTA_INCREMENTO.NEXTVAL INTO :NEW.ID_DETALLE_VENTA FROM DUAL;
END;
